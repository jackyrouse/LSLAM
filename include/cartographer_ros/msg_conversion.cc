...
PreparePointCloud2Message(const int64_t timestamp,
...
Eigen::Quaterniond
ToEigen(const MySubmapdata::Quaternion& quaternion)
{
...
Rigid3d
ToRigid3d(const MySubmapdata::Pose& pose)
{
...
Rigid3d
ToRigid3d(Eigen::Vector3d& vector, Eigen::Quaterniond& quaternion)
{
...
MySubmapdata::Pose ToGeometryMsgPose(const Rigid3d &rigid3d)
{
