...
public:
    ...
    MapBuilderBridge &
    operator=(const MapBuilderBridge &) = delete;

    void
    LoadState(const std::string &state_filename, bool load_frozen_state);
    int
    AddTrajectory(
        const std::set<
...
*/
    void
    HandlerSubmapQuery(::cartographer::mapping::SubmapId &submapid, MySubmapdata::MySubmapResponse &mysubmapresponse);
